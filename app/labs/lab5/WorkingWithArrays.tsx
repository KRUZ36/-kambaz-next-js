...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <a id="wd-remove-todo" className="btn btn-danger float-end"
      ...
      <a href={`${API}/${todo.id}/completed/${todo.completed}`}
        className="btn btn-primary float-end" id="wd-update-todo-completed">
      ...
      <a href={`${API}/${todo.id}/description/${todo.description}`}
        className="btn btn-primary float-end" id="wd-update-todo-description">
