    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-my-favorite-recipe">
          <li>Peel and slice green plantains.</li>
          <li>Fry plantain slices.</li>
          <li>Mash fried plantains with garlic and salt.</li>
          <li>Add olive oil or pork cracklings.</li>
      ...
      <div id="wd-images">
        ...
        <br />
        <img id="wd-teslabot" src="/images/teslabot.jpg" alt="Tesla Bot" />
      </div>
      {/* Forms */}
      <div id="wd-forms">
        <h4>Form Elements</h4>
      ...
      to get dummy text
      <br />
      <a href="https://github.com/KRUZ36/-kambaz-next-js" id="wd-github">
